    ...
    if (!document.querySelector('.mobile-contact-bar')) {
      ...
      bar.innerHTML =
        '<a href="tel:+382[za unos]" class="mcb-btn mcb-call" aria-label="Pozovite Polistibrick">' +
          ...
          '<span>Pozovite</span>' +
        '</a>' +
        '<a href="mailto:contact@polistibrick.com" class="mcb-btn mcb-email" aria-label="Pošaljite e-mail">' +
  ...
  function buildCountryPickerModal() {
    ...
    modal.innerHTML = `
      ...
      <div class="country-picker-panel">
        ...
        <p class="country-picker-foot">Vaša zemlja nije na listi? Pišite nam na <a href="mailto:info@polistibrick.eu">info@polistibrick.eu</a></p>
      </div>
    `;
