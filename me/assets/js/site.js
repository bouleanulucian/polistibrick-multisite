  ...
  const NAV_HTML = `
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="Meni navigacije" aria-hidden="true">
      <div class="nav-drawer-group">
        ...
        <div class="nav-acc">
          <a href="${BASE}proizvodi/polistibrick/">Polistibrick</a>
          <a href="${BASE}proizvodi/polistiwall/">Polistiwall</a>
          <a href="${BASE}proizvodi/polistisip/">PolistiSIP</a>
        </div>
      </div>
      <div class="nav-drawer-group">
    ...
    <div class="container container--wide">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Proizvodi</h5>
          <ul>
            <li><a href="${BASE}proizvodi/polistibrick/">Polistibrick</a></li>
            <li><a href="${BASE}proizvodi/polistiwall/">Polistiwall</a></li>
            <li><a href="${BASE}proizvodi/polistisip/">PolistiSIP</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h5>Rješenja</h5>
