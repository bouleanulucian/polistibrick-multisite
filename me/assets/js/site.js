...
(function () {
  ...
  const NAV_HTML = `
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="Meni navigacije" aria-hidden="true">
      ...
      <div class="nav-drawer-group">
        ...
        <div class="nav-acc">
          <a href="${BASE}projekti/">Svi projekti</a>
    ...
    <div class="container container--wide">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Resursi</h5>
          <ul>
            <li><a href="${BASE}projekti/">Projekti</a></li>
            <li><a href="${BASE}ustede/">Kalkulator ušteda</a></li>
  ...
  function inject() {
    ...
    if (!document.querySelector('.mobile-contact-bar')) {
      ...
      const phoneRaw = '+382[za unos]';
      const hasPhone = phoneRaw && phoneRaw.indexOf('[') === -1 && phoneRaw.indexOf('{') === -1;
      bar.innerHTML =
        (hasPhone ?
        '<a href="tel:' + phoneRaw + '" class="mcb-btn mcb-call" aria-label="Pozovite Polistibrick">' +
