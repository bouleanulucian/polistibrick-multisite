...
(function () {
  ...
  var TEXT = {
    body: 'Koristimo kolačiće i usluge trećih strana za poboljšanje sajta. Pogledajte našu',
    link: 'politiku kolačića',
    and: 'i',
    privacy: 'politiku privatnosti',
    aria: 'Saglasnost za kolačiće',
    accept: 'Prihvati',
    refuse: 'Odbij',
    privacySlug: 'privatnost',
  };
    ...
    bar.innerHTML =
      '<div class="pb-cookie-inner">' +
        '<p class="pb-cookie-text">' + bodyText + ' ' +
          '<a href="' + base + 'legal/kolacici/">' + linkText + '</a> ' +
