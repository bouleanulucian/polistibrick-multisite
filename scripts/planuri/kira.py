#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""KIRA — casă cu etaj, 127 m², trei dormitoare.

Instagram nadiyni_stiny / Da0qMzalH1U. Ariile scrise:
...
m = Model(
    ...
    extra=[("Gabarit parter", "13,00 × 8,00 m"),
           ...
           ("Băi", "2")],
    observatii=[
        "Reprodusă după nadiyni_stiny Da0qMzalH1U, 127 m², trei dormitoare.",
...
if __name__ == "__main__":
    ...
    plansa(m, "/private/tmp/planuri/kira.svg")
    ...
    for lat in "NS":
        elevatie_png(p, lat, "/private/tmp/planuri/kira-el-%s.png" % lat)
        elevatie_png(e, lat, "/private/tmp/planuri/kira-e-el-%s.png" % lat)
