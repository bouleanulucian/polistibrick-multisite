...
(function () {
  ...
  const CFG = {
    ...
    country: 'FR',
    countryName: 'France',
    fallbackEmail: dec64('Y29udGFjdEBwb2xpc3RpYnJpY2suZnI='),
    subjects: {
      contact: 'Contact — Polistibrick France',
      devis: 'Demande de devis — Polistibrick France',
      partner: 'Candidature partenaire — Polistibrick France',
      review: 'Nouvel avis client — Polistibrick France',
    },
  };
