...
(function () {
  ...
  const NAV_HTML = `
    <div class="nav-inner">
      <a href="${BASE}" class="logo nav-logo" aria-label="Polistibrick — Startseite">
      ...
      <div class="nav-cta">
        ...
        <a href="${BASE}devis/" class="btn btn-primary nav-cta-devis">Kostenloses Angebot</a>
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="{{ui.nav_drawer_aria}}" aria-hidden="true">
      <div class="nav-drawer-group">
        <button class="nav-drawer-title" aria-expanded="false">Produkte<span class="nd-caret">▾</span></button>
        <div class="nav-acc">
          <a href="${BASE}produits/murs-mbk/">MBK-Wände</a>
          <a href="${BASE}produits/planchers-pbk/">PBK-Decken</a>
          <a href="${BASE}produits/toit-tbk/">TBK-Dach</a>
        </div>
      </div>
      <div class="nav-drawer-group">
        <button class="nav-drawer-title" aria-expanded="false">Lösungen<span class="nd-caret">▾</span></button>
        <div class="nav-acc">
          <a href="${BASE}pour/proprietaires/">Für Eigentümer</a>
          <a href="${BASE}pour/architectes/">Für Architekten</a>
          <a href="${BASE}pour/constructeurs/">Für Bauunternehmen</a>
          <a href="${BASE}pour/investisseurs/">Für Investoren</a>
          <a href="${BASE}devenir-partenaire/" class="partner-link">→ Partner werden</a>
        </div>
      </div>
      <div class="nav-drawer-group">
        <button class="nav-drawer-title" aria-expanded="false">Projekte<span class="nd-caret">▾</span></button>
        <div class="nav-acc">
          <a href="${BASE}projets/">Realisierte Häuser</a>
          <a href="${BASE}temoignages/">Erfahrungsberichte (Video)</a>
        </div>
      </div>
      <div class="nav-drawer-group">
        <button class="nav-drawer-title" aria-expanded="false">Rechner<span class="nd-caret">▾</span></button>
        <div class="nav-acc">
          <a href="${BASE}calculateur/">Kostenrechner</a>
          <a href="${BASE}economies/">Einsparrechner</a>
        </div>
      </div>
      <div class="nav-drawer-group">
        <button class="nav-drawer-title" aria-expanded="false">Ressourcen<span class="nd-caret">▾</span></button>
        <div class="nav-acc">
          <a href="${BASE}ressources/blog/">Blog</a>
          <a href="${BASE}ressources/faq/">Häufige Fragen</a>
        </div>
      </div>
      <div class="nav-drawer-group">
        <button class="nav-drawer-title" aria-expanded="false">Über uns<span class="nd-caret">▾</span></button>
        <div class="nav-acc">
          <a href="${BASE}a-propos/">Das Unternehmen</a>
          <a href="${BASE}a-propos/brevet/">Das Polistibrick-Patent</a>
          <a href="${BASE}a-propos/certifications/">Zertifizierungen</a>
          <a href="${BASE}a-propos/usines/">Unsere Werke</a>
          <a href="${BASE}a-propos/fondateur/">Das Team</a>
        </div>
      </div>
      <div class="nav-drawer-cta">
        <a href="${BASE}contact/" class="btn btn-ghost">Kontakt</a>
        <a href="${BASE}devis/" class="btn btn-primary">Angebot anfordern</a>
      </div>
    </aside>
  `;
    ...
    <div class="container container--wide">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Produkte</h5>
          <ul>
            <li><a href="${BASE}produits/murs-mbk/">MBK-Wände</a></li>
            <li><a href="${BASE}produits/planchers-pbk/">PBK-Decken</a></li>
            <li><a href="${BASE}produits/toit-tbk/">TBK-Dach</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h5>Lösungen</h5>
          <ul>
            <li><a href="${BASE}pour/proprietaires/">Eigentümer</a></li>
            <li><a href="${BASE}pour/architectes/">Architekten</a></li>
            <li><a href="${BASE}pour/constructeurs/">Bauunternehmen</a></li>
            <li><a href="${BASE}pour/investisseurs/">Investoren</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h5>Ressourcen</h5>
          <ul>
            <li><a href="${BASE}projets/">Realisierte Projekte</a></li>
            <li><a href="${BASE}ressources/blog/">Blog</a></li>
            <li><a href="${BASE}ressources/faq/">Häufige Fragen</a></li>
            <li><a href="${BASE}calculateur/">Kostenrechner</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h5>Unternehmen</h5>
          <ul>
            <li><a href="${BASE}a-propos/">Über uns</a></li>
            <li><a href="${BASE}a-propos/brevet/">Das Polistibrick-Patent</a></li>
            <li><a href="${BASE}a-propos/certifications/">Zertifizierungen</a></li>
            <li><a href="${BASE}a-propos/usines/">Unsere Werke</a></li>
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-bottom-links">
          <a href="${BASE}legal/mentions-legales/">Impressum</a>
          <a href="${BASE}legal/conditions/">Bedingungen</a>
          <a href="${BASE}legal/confidentialite/">Datenschutz</a>
          <a href="${BASE}legal/cookies/">Cookies</a>
          <a href="${BASE}legal/durabilite/">Nachhaltigkeit</a>
        </div>
      </div>
    </div>
  `;
  ...
  function inject() {
    ...
    if (!document.querySelector('.mobile-contact-bar')) {
      ...
      bar.innerHTML =
        '<a href="tel:+41[ausfüllen]" class="mcb-btn mcb-call" aria-label="Polistibrick anrufen">' +
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>' +
          '<span>Anrufen</span>' +
        '</a>' +
        '<a href="mailto:contact@polistibrick.com" class="mcb-btn mcb-email" aria-label="E-Mail senden">' +
