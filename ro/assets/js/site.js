  ...
  const NAV_HTML = `
      ...
      <div class="nav-cta">
        ...
        <div class="country-switcher" data-country-switcher>
          ...
          <div class="country-switcher-panel" role="menu" aria-hidden="true">
            ...
            <a href="#" data-country="me" data-domain="https://polistibrick.me" data-folder="me" class="country-switcher-item"><span class="flag">🇲🇪</span><span class="name">Muntenegru</span><span class="domain">polistibrick.me</span></a>
          </div>
        </div>
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="Meniu navigare" aria-hidden="true">
      <div class="nav-drawer-group">
        ...
        <div class="nav-acc">
          <a href="${BASE}produse/polistibrick/">Polistibrick</a>
          <a href="${BASE}produse/polistiwall/">Polistiwall</a>
          <a href="${BASE}produse/polistisip/">PolistiSIP</a>
        </div>
      </div>
      <div class="nav-drawer-group">
    ...
    <div class="container container--wide">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Produse</h5>
          <ul>
            <li><a href="${BASE}produse/polistibrick/">Polistibrick</a></li>
            <li><a href="${BASE}produse/polistiwall/">Polistiwall</a></li>
            <li><a href="${BASE}produse/polistisip/">PolistiSIP</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h5>Soluții</h5>
