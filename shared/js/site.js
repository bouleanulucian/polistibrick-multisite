  ...
  const NAV_HTML = `
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="{{ui.nav_drawer_aria}}" aria-hidden="true">
      <div class="nav-drawer-group">
        ...
        <div class="nav-acc">
          <a href="${BASE}produse/polistibrick/">{{ui.pereti_mbk}}</a>
          <a href="${BASE}produse/polistiwall/">{{ui.acoperis_tbk}}</a>
