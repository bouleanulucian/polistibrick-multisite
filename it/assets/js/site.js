  ...
  const NAV_HTML = `
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="Menu di navigazione" aria-hidden="true">
      <div class="nav-drawer-group">
        ...
        <div class="nav-acc">
          <a href="${BASE}prodotti/polistibrick/">Polistibrick</a>
          <a href="${BASE}prodotti/polistiwall/">Polistiwall</a>
          <a href="${BASE}prodotti/polistisip/">PolistiSIP</a>
        </div>
      </div>
      <div class="nav-drawer-group">
    ...
    <div class="container container--wide">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Prodotti</h5>
          <ul>
            <li><a href="${BASE}prodotti/polistibrick/">Polistibrick</a></li>
            <li><a href="${BASE}prodotti/polistiwall/">Polistiwall</a></li>
            <li><a href="${BASE}prodotti/polistisip/">PolistiSIP</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h5>Soluzioni</h5>
