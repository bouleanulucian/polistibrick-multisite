...
(function () {
  ...
  const NAV_HTML = `
    ...
    <aside class="nav-drawer" id="navDrawerShared" aria-label="Menu di navigazione" aria-hidden="true">
      ...
      <div class="nav-drawer-group">
        ...
        <div class="nav-acc">
          <a href="${BASE}progetti/">Tutti i progetti</a>
    ...
    <div class="container container--wide">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h5>Risorse</h5>
          <ul>
            <li><a href="${BASE}progetti/">Progetti</a></li>
            <li><a href="${BASE}risparmi/">Calcolatore risparmi</a></li>
  ...
  function inject() {
    ...
    if (!document.querySelector('.mobile-contact-bar')) {
      ...
      bar.setAttribute('aria-label', 'Contatto rapido');
      ...
      const phoneRaw = '+393281648085';
      const hasPhone = phoneRaw && phoneRaw.indexOf('[') === -1 && phoneRaw.indexOf('{') === -1;
      bar.innerHTML =
        (hasPhone ?
        '<a href="tel:' + phoneRaw + '" class="mcb-btn mcb-call" aria-label="Chiama Polistibrick">' +
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>' +
          '<span>Chiama</span>' +
        '</a>' : '') +
        '<a href="#" data-m64="Y29udGFjdEBwb2xpc3RpYnJpY2suY29t" class="mcb-btn mcb-email" aria-label="Invia email">' +
...
window.PB_SLUGS = {"ro":{},"fr":{"produse":"produits","pentru":"pour","despre":"a-propos","resurse":"ressources","proiecte":"projets","economii":"economies","oferta":"devis","comparatie":"comparaison","calculator":"calculateur","testimoniale":"temoignages","devino-partener":"devenir-partenaire","pereti-mbk":"murs-mbk","planseu-pbk":"planchers-pbk","acoperis-tbk":"toit-tbk","accesorii":"accessoires","proprietari":"proprietaires","arhitecti":"architectes","constructori":"constructeurs","investitori":"investisseurs","certificari":"certifications","fabrici":"usines","echipa":"fondateur","patent":"brevet","casa-cluj-napoca":"maison-cluj-napoca","ansamblu-lyon":"ensemble-lyon","confidentialitate":"confidentialite","sustenabilitate":"durabilite","termeni":"conditions","mentiuni-legale":"mentions-legales","montaj":"montage"},"de":{"produse":"produits","pentru":"pour","despre":"a-propos","resurse":"ressources","proiecte":"projets","economii":"economies","oferta":"devis","comparatie":"comparaison","calculator":"calculateur","testimoniale":"temoignages","devino-partener":"devenir-partenaire","pereti-mbk":"murs-mbk","planseu-pbk":"planchers-pbk","acoperis-tbk":"toit-tbk","accesorii":"accessoires","proprietari":"proprietaires","arhitecti":"architectes","constructori":"constructeurs","investitori":"investisseurs","certificari":"certifications","fabrici":"usines","echipa":"fondateur","patent":"brevet","casa-cluj-napoca":"maison-cluj-napoca","ansamblu-lyon":"ensemble-lyon","confidentialitate":"confidentialite","sustenabilitate":"durabilite","termeni":"conditions","mentiuni-legale":"mentions-legales","montaj":"montage"},"nl":{"produse":"produits","pentru":"pour","despre":"a-propos","resurse":"ressources","proiecte":"projets","economii":"economies","oferta":"devis","comparatie":"comparaison","calculator":"calculateur","testimoniale":"temoignages","devino-partener":"devenir-partenaire","pereti-mbk":"murs-mbk","planseu-pbk":"planchers-pbk","acoperis-tbk":"toit-tbk","accesorii":"accessoires","proprietari":"proprietaires","arhitecti":"architectes","constructori":"constructeurs","investitori":"investisseurs","certificari":"certifications","fabrici":"usines","echipa":"fondateur","patent":"brevet","casa-cluj-napoca":"maison-cluj-napoca","ansamblu-lyon":"ensemble-lyon","confidentialitate":"confidentialite","sustenabilitate":"durabilite","termeni":"conditions","mentiuni-legale":"mentions-legales","montaj":"montage"},"en":{"produse":"products","pentru":"for","despre":"about","resurse":"resources","proiecte":"projects","economii":"savings","oferta":"quote","comparatie":"comparison","calculator":"calculator","testimoniale":"testimonials","devino-partener":"become-a-partner","pereti-mbk":"walls-mbk","planseu-pbk":"floors-pbk","acoperis-tbk":"roof-tbk","accesorii":"accessories","proprietari":"homeowners","arhitecti":"architects","constructori":"builders","investitori":"investors","certificari":"certifications","fabrici":"factories","echipa":"founder","patent":"patent","casa-cluj-napoca":"house-cluj-napoca","ansamblu-lyon":"lyon-development","confidentialitate":"privacy","sustenabilitate":"sustainability","termeni":"terms","mentiuni-legale":"legal-notice","montaj":"installation"},"ie":{"produse":"products","pentru":"for","despre":"about","resurse":"resources","proiecte":"projects","economii":"savings","oferta":"quote","comparatie":"comparison","calculator":"calculator","testimoniale":"testimonials","devino-partener":"become-a-partner","pereti-mbk":"walls-mbk","planseu-pbk":"floors-pbk","acoperis-tbk":"roof-tbk","accesorii":"accessories","proprietari":"homeowners","arhitecti":"architects","constructori":"builders","investitori":"investors","certificari":"certifications","fabrici":"factories","echipa":"founder","patent":"patent","casa-cluj-napoca":"house-cluj-napoca","ansamblu-lyon":"lyon-development","confidentialitate":"privacy","sustenabilitate":"sustainability","termeni":"terms","mentiuni-legale":"legal-notice","montaj":"installation"},"es":{"produse":"productos","pentru":"para","despre":"sobre-nosotros","resurse":"recursos","proiecte":"proyectos","economii":"ahorros","oferta":"presupuesto","comparatie":"comparacion","calculator":"calculadora","testimoniale":"testimonios","devino-partener":"ser-socio","pereti-mbk":"muros-mbk","planseu-pbk":"forjados-pbk","acoperis-tbk":"techo-tbk","accesorii":"accesorios","proprietari":"propietarios","arhitecti":"arquitectos","constructori":"constructores","investitori":"inversores","certificari":"certificaciones","fabrici":"fabricas","echipa":"fundador","patent":"patente","casa-cluj-napoca":"casa-cluj-napoca","ansamblu-lyon":"conjunto-lyon","confidentialitate":"privacidad","sustenabilitate":"sostenibilidad","termeni":"condiciones","mentiuni-legale":"aviso-legal","montaj":"montaje","ce-este-casa-passiva":"que-es-una-casa-pasiva"},"it":{"produse":"prodotti","pentru":"per","despre":"chi-siamo","resurse":"risorse","proiecte":"progetti","economii":"risparmi","oferta":"preventivo","comparatie":"confronto","calculator":"calcolatore","testimoniale":"testimonianze","devino-partener":"diventa-partner","pereti-mbk":"pareti-mbk","planseu-pbk":"solai-pbk","acoperis-tbk":"tetto-tbk","accesorii":"accessori","proprietari":"proprietari","arhitecti":"architetti","constructori":"costruttori","investitori":"investitori","certificari":"certificazioni","fabrici":"fabbriche","echipa":"fondatore","patent":"brevetto","casa-cluj-napoca":"casa-cluj-napoca","ansamblu-lyon":"complesso-lyon","confidentialitate":"privacy","sustenabilitate":"sostenibilita","termeni":"condizioni","mentiuni-legale":"note-legali","montaj":"montaggio","cookies":"cookie"},"me":{"produse":"proizvodi","pentru":"za","despre":"o-nama","resurse":"resursi","proiecte":"projekti","economii":"ustede","oferta":"ponuda","comparatie":"poredjenje","calculator":"kalkulator","testimoniale":"svjedocanstva","devino-partener":"postani-partner","pereti-mbk":"zidovi-mbk","planseu-pbk":"podovi-pbk","acoperis-tbk":"krov-tbk","accesorii":"pribor","proprietari":"vlasnici","arhitecti":"arhitekti","constructori":"gradjevinci","investitori":"investitori","certificari":"sertifikati","fabrici":"fabrike","echipa":"osnivac","patent":"patent","casa-cluj-napoca":"kuca-cluj-napoca","ansamblu-lyon":"kompleks-lyon","villa-valencia":"vila-valencia","confidentialitate":"privatnost","sustenabilitate":"odrzivost","termeni":"uslovi","mentiuni-legale":"pravne-napomene","montaj":"montaza","cookies":"kolacici"}};
  ...
  function countrySwitcherShared() {
    ...
    // Les slugs sont traduits : /ro/preventivo/ existe en français sous /fr/devis/.
    // Échanger seulement le dossier pays produisait /fr/preventivo/ — un 404 sur presque
  ...
  function buildCountryPickerModal() {
    ...
    modal.innerHTML = `
      ...
      <div class="country-picker-panel">
        ...
        <p class="country-picker-foot">Il tuo paese non è elencato? Scrivici a <a href="#" data-m64="aW5mb0Bwb2xpc3RpYnJpY2suZXU=">Email</a></p>
      </div>
    `;
